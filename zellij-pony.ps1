...
$Chromes = @{
  twilight = @{
    ru_bg='#b48ce8'; ru_base='#1a1033'; ru_e0='#6b3fa0'; ru_e1='#f5a9d0'; ru_e2='#1a1033'; ru_e3='#2d1b4e'
    rs_bg='#f5a9d0'; rs_base='#1a1033'; rs_e0='#6b3fa0'; rs_e1='#b48ce8'; rs_e2='#1a1033'; rs_e3='#2d1b4e'
    frame_sel='#b48ce8'; frame_un='#2d1b4e'; frame_hl='#f5a9d0'
    ok='#4e9d6a'; err='#e85b8a'
  }
  rainbow = @{
    ru_bg='#5dadec'; ru_base='#0d1b2a'; ru_e0='#ff6b6b'; ru_e1='#ffd93d'; ru_e2='#0d1b2a'; ru_e3='#27385c'
    rs_bg='#ff6b6b'; rs_base='#0d1b2a'; rs_e0='#ffd93d'; rs_e1='#5dadec'; rs_e2='#0d1b2a'; rs_e3='#27385c'
    frame_sel='#89cff0'; frame_un='#1b3a5c'; frame_hl='#ff6b6b'
    ok='#6bcf7f'; err='#ff6b6b'
  }
  pinkie = @{
    ru_bg='#e85ba8'; ru_base='#2d1424'; ru_e0='#6cb4ee'; ru_e1='#fde2f3'; ru_e2='#2d1424'; ru_e3='#5c2347'
    rs_bg='#6cb4ee'; rs_base='#2d1424'; rs_e0='#e85ba8'; rs_e1='#fde2f3'; rs_e2='#2d1424'; rs_e3='#5c2347'
    frame_sel='#f5a9d0'; frame_un='#5c2347'; frame_hl='#6cb4ee'
    ok='#94c973'; err='#e85ba8'
  }
  applejack = @{
    ru_bg='#d97706'; ru_base='#2a1810'; ru_e0='#4a8c3a'; ru_e1='#fde8c8'; ru_e2='#2a1810'; ru_e3='#4d2e1a'
    rs_bg='#4a8c3a'; rs_base='#fde8c8'; rs_e0='#fde8c8'; rs_e1='#d97706'; rs_e2='#2a1810'; rs_e3='#4d2e1a'
    frame_sel='#f0a04b'; frame_un='#4d2e1a'; frame_hl='#4a8c3a'
    ok='#4a8c3a'; err='#d97706'
  }
  rarity = @{
    ru_bg='#9d7ec9'; ru_base='#1a1530'; ru_e0='#7fb8d4'; ru_e1='#d4c0ed'; ru_e2='#1a1530'; ru_e3='#2d2447'
    rs_bg='#7fb8d4'; rs_base='#1a1530'; rs_e0='#9d7ec9'; rs_e1='#f5edff'; rs_e2='#1a1530'; rs_e3='#2d2447'
    frame_sel='#d4c0ed'; frame_un='#2d2447'; frame_hl='#7fb8d4'
    ok='#9be3c8'; err='#f5a9d0'
  }
  fluttershy = @{
    ru_bg='#fde9a4'; ru_base='#2d2418'; ru_e0='#c8506e'; ru_e1='#9bb86b'; ru_e2='#2d2418'; ru_e3='#4a3d28'
    rs_bg='#f4a8c8'; rs_base='#2d2418'; rs_e0='#9bb86b'; rs_e1='#fde9a4'; rs_e2='#2d2418'; rs_e3='#4a3d28'
